    ...
    <>
      <header className="flex justify-between items-center h-full w-full shadow-0 pb-4 bg-blue-400">
        ...
        <ul className="flex justify-between items-center h-10 w-1/2 pr-3 lg:pr-32 font-mono">
          ...
          <li className="text-slate-200 relative cursor-pointer hover:text-white after:content-[''] after:absolute after:left-0 after:-bottom-1 after:bg-gradient-to-r from-red-200 via-red-300 to-yellow-200 after:h-1 after:w-0 after:rounded-xl after:duration-300 hover:after:w-full">About</li>
          <li className="text-slate-200 relative cursor-pointer hover:text-white after:content-[''] after:absolute after:left-0 after:-bottom-1 after:bg-gradient-to-r from-red-200 via-red-300 to-yellow-200 after:h-1 after:w-0 after:rounded-xl after:duration-300 hover:after:w-full">Contact</li>
          <Link href="/signup">
